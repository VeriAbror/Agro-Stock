<!-- filepath: resources/views/admin/master.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body class="bg-gray-100 font-sans text-gray-800">
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="bg-[#52C4D5] w-64 flex-shrink-0 shadow-md flex flex-col justify-between fixed h-full z-10">
            <div>
                ...
                <nav class="mt-4 flex flex-col gap-2">
                    ...
                    <a href="/master" class="flex items-center gap-3 px-4 py-3 rounded-lg font-medium bg-white/20 text-white">
                    ...
                    <a href="/reports" class="flex items-center gap-3 px-4 py-3 rounded-lg font-medium text-white hover:bg-white/20 transition">
        ...
        <!-- Main Content - Added margin left and main-content class -->
        <main class="flex-1 p-6 main-content ml-64">
            ...
            <div class="bg-[#52C4D5] rounded-2xl p-6 flex flex-col md:flex-row items-center justify-between mb-8 shadow">
                <div>
                    <h2 class="text-2xl font-bold text-white mb-2">Master Stock</h2>
                    <p class="text-white/90">Kelola data master stock barang di sini.</p>
                </div>
