<!-- filepath: resources/views/petugas/mutasi.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Mutasi Stock Petugas</title>
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="bg-[#52C4D5] w-64 flex-shrink-0 shadow-md flex flex-col justify-between fixed h-full z-10">
            <div>
                ...
                <nav class="mt-4 flex flex-col gap-2">
                    ...
                    <a href="/mutasi" class="flex items-center gap-3 px-4 py-3 rounded-lg font-medium bg-white/20 text-white">
        ...
        <main class="flex-1 p-6 main-content ml-64">
            ...
            <div class="bg-[#52C4D5] rounded-2xl p-6 flex flex-col md:flex-row items-center justify-between mb-8 shadow">
                <div>
                    <h2 class="text-2xl font-bold text-white mb-2">Mutasi Stock</h2>
                    <p class="text-white/90">Kelola data mutasi stock barang di sini.</p>
                </div>
