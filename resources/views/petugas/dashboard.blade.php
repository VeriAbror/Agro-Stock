<!-- filepath: resources/views/petugas/dashboard.blade.php -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <main class="flex-1 p-6 main-content ml-64">
            ...
            <div class="bg-[#52C4D5] rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between mb-8 shadow">
                <div>
                    ...
                    <p class="text-white/90">Ini adalah halaman dashboard untuk role <strong>Petugas</strong>.</p>
                </div>
                <a href="/profile" class="relative group">
                    <img src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png" alt="Petugas" class="w-24 h-24 object-contain rounded-xl mt-6 md:mt-0 transition-transform duration-200 group-hover:scale-105" />
                    <span class="absolute inset-0 flex items-center justify-center rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-200 text-white font-semibold text-lg">Profile</span>
                </a>
            </div>

            <!-- Section -->
            <section>
                <h2 class="text-xl font-semibold text-[#52C4D5] mb-6">Informasi</h2>
                <div class="bg-white rounded-xl shadow p-5">
                    <p>Silakan gunakan menu di samping untuk melihat menu yang tersedia</p>
                </div>
            </section>
        </main>
    </div>
